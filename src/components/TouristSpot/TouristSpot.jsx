...
const TouristSpot = ({ tours }) => {


    const { tourists_spot_name, average_cost, seasonality, travel_time, totalVisitorsPerYear, image } = tours;
    ...
    return (
        <div className="container mx-auto w-10/12 lg:w-[75%]">
            ...
            <div className="card lg:w-96 bg-base-100 border-2 mt-4">
                <figure className="px-10 pt-10">
                    <img src={image} alt="" className="rounded-xl bg-[#F3F3F3] h-[230px] w-[350px] md:w-[700px] md:h-[300px] lg:w-[800px] lg:h-[200px]" />
                </figure>
                <div className="card-body">
                    <div className="flex flex-col lg:flex-row lg:gap-14 gap-6">
                        <h2 className="font-bold text-xl font-roboto">Tourist Spot: <span className="font-normal font-sedan">{tourists_spot_name}</span></h2>
                    </div>
                    ...
                    <Link to=''>
                        <button className="btn bg-[#FACF39] text-black hover:bg-white hover:text-black hover:border-amber-300">View Details</button>
                    </Link>
